...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Add {{ $entryLabelSingular }}</h1>
        <p class="text-gray-600">{{ $event->name }}</p>
    </div>

    <form action="{{ route('admin.events.entries.store', $event) }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button type="submit" class="btn-primary">
                <i class="fas fa-save mr-2"></i> Create {{ $entryLabelSingular }}
            </button>
        </div>
    </form>
</div>
